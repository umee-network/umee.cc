<template>
  ...
  >
    ...
    />
    <linearGradient
      id="SVGID_00000127024994337055984090000004948896097055572901_"
      gradientUnits="userSpaceOnUse"
      x1="76.719"
      y1="70.177"
      x2="99.452"
    ...
    <path
      d="M.1 2.9v53.6-2.1c.4 45.8 38.8 84.9 86.3 84.9s85.9-37 86.3-82.8V2.9s-12-5.8-25.6 8.1c-8.7 8.9-15.7 41.1-34.4 41.3-25 .4-42-32.8-62.3-45.2C29.1-5.9.1 2.9.1 2.9z"
      fill="url(#SVGID_00000127024994337055984090000004948896097055572901_)"
    />
    <linearGradient
      id="SVGID_00000044167896939555990620000017791044521634152613_"
      gradientUnits="userSpaceOnUse"
      x1="-5.976"
      y1="112.594"
      x2="191.881"
    ...
    <path
      ...
      fill="url(#SVGID_00000044167896939555990620000017791044521634152613_)"
    />
    <linearGradient
      id="SVGID_00000009554531767720432860000002581399139075645615_"
      gradientUnits="userSpaceOnUse"
      x1="66.553"
      y1="93.575"
      x2="96.863"
    ...
    <path
      d="M172.7 61.7V24.5c-4.9.8-10.9 3.2-17.2 9-9.8 9-17.6 41.5-38.6 41.8-28 .4-47.1-33.2-69.9-45.8-15.9-8.6-35.6-7.6-47-5.9v38.2-2.3c.4 49 38.9 90.8 86.3 90.8 47.5 0 86-39.6 86.4-88.6z"
      fill="url(#SVGID_00000009554531767720432860000002581399139075645615_)"
    />
    <linearGradient
      id="SVGID_00000096046437940670527320000014792765798771504034_"
      gradientUnits="userSpaceOnUse"
      x1="-14.459"
      y1="125.184"
      x2="163.191"
    ...
    <path
      ...
      fill="url(#SVGID_00000096046437940670527320000014792765798771504034_)"
    />
    <path
...
export default {
  ...
  computed: {
    colorClass: function () {
      if (this.color) {
        return {
          'fill-navy': this.color && this.color === 'dark',
          'fill-white': this.color && this.color === 'light',
        }
      } else {
        return 'fill-navy dark:fill-white'
      }
    },
  },
}
